...
/* Private macros ------------------------------------------------------------*/
#define REDUCTION 3591.0f / 187.0f
/* Private types -------------------------------------------------------------*/

/* Private variables ---------------------------------------------------------*/
//extern Class_DJI_Motor_C620 Motor_Wheel[4];
...
void Class_Tricycle_Chassis::Init(float __Velocity_X_Max, float __Velocity_Y_Max, float __Omega_Max, float __Steer_Power_Ratio) {
    ...
    // 轮向电机ID初始化
    Motor_Wheel[0].Init(&hcan1, DJI_Motor_ID_0x201, DJI_Motor_Control_Method_OMEGA, REDUCTION);
    Motor_Wheel[1].Init(&hcan1, DJI_Motor_ID_0x202, DJI_Motor_Control_Method_OMEGA, REDUCTION);
    Motor_Wheel[2].Init(&hcan1, DJI_Motor_ID_0x203, DJI_Motor_Control_Method_OMEGA, REDUCTION);
    Motor_Wheel[3].Init(&hcan1, DJI_Motor_ID_0x204, DJI_Motor_Control_Method_OMEGA, REDUCTION);
